...
$query = "UPDATE patients SET first_name = ?, last_name = ?, address = ?, email = ?, phone = ?, dob = ?, gender = ?, emergency_name = ?, relationship = ?, address1 = ?, emergency_phone = ?, medical_ailment = ?, blood_type = ?, allergies = ?, surgery_history = ?, smoke_history = ?, drink_alcohol = ?, medicare_no = ?, private_insurance = ?, insurance_no = ? WHERE id = ".$id;
...
if (mysqli_stmt_affected_rows($stmt)) {
    echo "<script>alert('Updated');window.location.href='patientindex.php';</script>";
} else {
